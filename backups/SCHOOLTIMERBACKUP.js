...
function moveColor()
{
  ...
  document.getElementById("mydiv").style.top = "999999px";
    onoff = 0;
  }
}
...
console.log(formatted_date)
  ...
  if (formatted_date == "2019-5-24" || formatted_date == "2019-5-25" || formatted_date == "2019-5-26" || formatted_date == "2019-5-27") {
   daysUntil = 15; 
  }
  ...
  if (formatted_date == "2019-5-31" || formatted_date == "2019-6-1" || formatted_date == "2019-6-2") {
   daysUntil = 10; 
  }
  ...
  if (formatted_date == "2019-6-7" || formatted_date == "2019-6-8" || formatted_date == "2019-6-9") {
   daysUntil = 5; 
  }
...
function featureFunction() {
  ...
  var feature;
  var type = prompt("Enter the feature you'd like to see in the next update of schooltimer!", "");
  if (type == null || type == "") {
    //txt = "User cancelled the prompt.";
  } else {
    feature = type;
         var xhr = new XMLHttpRequest();
  var myURL = "https://maker.ifttt.com/trigger/feature/with/key/bc48cOTCsHu3gBrt1nX1EE?value1=" + feature;
...
function emailFunction() {
  ...
  if (type == null || type == "") {
    ...
    email = type;
         var xhr = new XMLHttpRequest();
  var myURL = "https://maker.ifttt.com/trigger/email/with/key/bc48cOTCsHu3gBrt1nX1EE?value1=" + email;
xhr.open("POST", myURL, true);
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.send(JSON.stringify({
    value: "value"
  ...
  function lunch() {
    ...
    if (isLunchOn == 0) {
     // alert("lunch is on");
      ...
      document.getElementById("lunchAlertText").innerHTML = "Lunch Mode Enabled";
     ...
     isLunchOn = 1;
      ...
      document.getElementById("lunchAlertText").innerHTML = "Lunch Mode Disabled";
...
function selectPreset() {
  ...
  if (preset == 'Light') {
    ...
    buttonTxtPres = 'black';
                  ...
                  document.getElementById("video").style.color = buttonTxtPres;
                   document.getElementById("myBtn").style.color = buttonTxtPres;
                   document.getElementById("feature").style.color = buttonTxtPres;
    ...
    buttonTxtPres = '#0f0f0f';
          ...
          document.getElementById("feature").style.backgroundColor = accent;
   ...
   function colorUpdate1() {
    ...
    document.body.style.backgroundColor = hex1;
       ...
       if (element == 'accent') {   //ACCENT
          ...
          document.getElementById("video").style.backgroundColor = hex1;
         ...
         if (element == 'text') { //TEXT
           ...
           if (element == 'sidebar') { //SIDEBAR
             ...
             if (element == 'sidebarTxt') {
                   ...
                   document.getElementById("lunchTxt").style.color = hex1;
...
function buttonColorChange () {
  ...
  fadeOutEffect();
      ...
      //document.getElementById("alertOverlay").style.top = "40%";
      //setTimeout(function() { document.getElementById("alertOverlay").style.top = "-20%"; }, 3000);
